...
/*
	AVISO! Esse arquivo está com o código da antiga página de etapas de produção,
	Irei usar ele apenas como apoio para deixar salvo os códigos que irei usar 
	na nova tela.

	Depois que eu terminar a nova tela de etapas de produção irei exlcuir esse arquivo.

	Então por enquanto apenas ignore ele.
*/
