          ...
          > 
              ...
              <div className="flex flex-col gap-7">
                ...
                <div className="flex gap-7 mb-2">
                  ...
                  <Form.Field name="filter-prod-minimum" className="flex flex-col">
                    <Form.Label asChild>
                      <span className="text-xl pb-2 font-light">Est. Mínimo:</span>
                    </Form.Label>
                    <Form.Control asChild>
                      <input
                        type="text"
                  ...
                  <Form.Field name="filter-prod-maximum" className="flex flex-col">
                    <Form.Label asChild>
                      <span className="text-xl pb-2 font-light">Est. Máximo:</span>
                    </Form.Label>
                    <Form.Control asChild>
                      <input
                        type="text"
                ...
                <div className="flex gap-8 mb-10">
                    ...
                    <Form.Field name="product-prod-validity" className="flex flex-col">
                        <Form.Label asChild>
                            <span className="text-xl pb-2 font-light">Data de Validade:</span>
                        </Form.Label>
                        <Form.Control asChild>
                            <input 
                                type="date" 
            ...
            <div className="max-w-[73vw] overflow-x-auto max-h-[570px] overflow-y-auto mb-15">
              <table className="w-full border-collapse">
                ...
                <tr className="bg-verdePigmento text-white shadow-thead">
                    {[
                        "Código", "Produto", "Categoria", "Tipo", "Quantidade", "Uni. de Medida", "Data de Validade",
                        "Est. Mínimo", "Est. Máximo", "Fornecedor", "Status", "Data de Cadastro", "Peso", "Preço por unidade",
                        "Descrição", "Observações", "Ações"
                    ].map((header) => (
                ...
                <tbody>
                  ...
                  <tr key={produto.codigo} className={index % 2 === 0 ? "bg-white" : "bg-[#E7E7E7]"}>
            ...
            >
                ...
                <div className="flex gap-x-25 mb-10">
                    ...
                    <Form.Label asChild>
                        <span className="text-xl pb-2 font-light">Descrição do produto:</span>
                    </Form.Label>
                    <Form.Control asChild>
                        <input
                        type="text"
                ...
                <div className="flex gap-x-15 mb-10 items-center">
                    ...
                    <Form.Label asChild>
                        <span className="text-xl pb-2 font-light">Preço por unidade:</span>
                    </Form.Label>
                    <Form.Control asChild>
                        <input
                        type="text"
