              ...
              <div className="flex w-full max-w-[1100px] h-[68vh] mb-10">
                ...
                <div className="w-1/4 bg-gray-200 rounded-xl sombra">
                    <div className="bg-green-800 p-4 rounded-t-xl">
                        <h2 className="text-white text-center text-lg font-semibold">Etapas de Produção</h2>
                            ...
                            <div className="max-w-[50vw] overflow-x-auto max-h-[400px] overflow-y-auto mb-10">
                                <table className="w-full border-collapse border border-gray-300">
                                    ...
                                    {ListSteps.map((step, index) => (
                                        ...
                                        <td className="border border-black px-4 py-2 whitespace-nowrap">{step.code}</td>
                                        <td className="border border-black px-4 py-2 whitespace-nowrap">{step.status}</td>
                                        <td className="border border-black px-4 py-2 whitespace-nowrap">{step.time}</td>
                                        <td className="border border-black px-4 py-2 whitespace-nowrap">{step.material}</td>
                                        <td className="border border-black px-4 py-2 whitespace-nowrap">{step.responsible}</td>
                                        <td className="border border-black px-4 py-2 whitespace-nowrap">
                                            {new Date().toLocaleDateString("pt-BR")}
                                        </td>
                                        <td className="border border-black px-4 py-2 whitespace-nowrap">27/03/2025</td>
                                        <td className="border border-black px-4 py-2 text-center">
                                            <button
                                            className="text-blue-600 cursor-pointer group relative"
                                            onClick={() => alert(`Observações: ${step.obs}`)}
                                            >
                                            <Eye />
