...
export { default as RecoverPassword } from "./page/RecoverPassword";
export { default as Dashboard } from "./page/Dashboard";
export { default as Clients } from "./page/Clients";
export { default as ConsumptionSupplies } from "./page/ConsumptionSupplies";
